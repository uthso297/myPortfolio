            ...
            <div className='md:flex gap-10 md:max-w-7xl mx-auto'>
                <div className='md:w-1/2 flex flex-col justify-center gap-10'>
                    ...
                    <div className='space-y-5'>
                        <p className='text-white lg:text-3xl text-xl'>I am Uthso - dedicated <span className='text-[#1d6ee6]'>web developer</span> with a passion for crafting visually appealing and responsive websites that deliver seamless user experiences.</p>
                ...
                <div className='md:w-1/2 mt-5 md:mt-0 md:ml-10'>
                    <img className="lg:max-w-xl max-w-sm rounded-lg object-cover" src={bannerImg} alt="Banner image showcasing Uthso" />
                </div>
            </div>
